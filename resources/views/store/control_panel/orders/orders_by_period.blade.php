...
@section('info')
    <div class="col-sm-9 padding-right">
        <div class="content-right">
            ...
            <form class="form-inline periodo-form" role="form" method="post" action="{{route('panel.post_by_period')}}">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group">
                    <label for="de">Período:</label>
                    <input type="date" class="form-control" id="de" style="width: 100px;" name="de">
                </div>
                <div class="form-group">
                    <label for="ate">-</label>
                    <input type="date" class="form-control" id="ate" style="width: 100px;" name="ate">
                </div>
